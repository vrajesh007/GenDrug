		...
		<div class="col-md-12">
			<div class="card">
				<div class="card-header">
					<h4 class="card-title" id="basic-layout-form-center">Symptom Details Form</h4>
				</div>
				<div class="card-body">
					<div class="px-3">
								...
								<div class="col-md-6">
									<div class="form-body">
										<div class="form-group">
											<label for="eventInput1">Symptom Name</label>
											<input type="text" id="eventInput1" class="form-control required"  name="symptomname">
										</div>
									</div>
								</div>
							</div>
							...
							<div class="form-actions center">
								...
								<button type="submit" class="btn btn-raised btn-primary"  name="submit" value='submit'>
									<i class="fa fa-check-square-o"></i> Submit
                                                            ...
                                                            <a href="Symptomdetails-table.php"  class="btn btn-raised btn-dark">View Table</a>
							</div>
						</form>	
