...
$insert=mysqli_query($con,"INSERT INTO categorydetails(Categ_id,Categ_name) VALUES ('','{$a}')") or die("Error" .mysqli_error($con));
if($insert)
{
		...
		<div class="col-md-12">
			<div class="card">
				<div class="card-header">
					<h4 class="card-title" id="basic-layout-form-center">Category Details Form</h4>
				</div>
				<div class="card-body">
					<div class="px-3">
								...
								<div class="col-md-6">
									<div class="form-body">
										<div class="form-group">
											...
											<input type="text" id="eventInput1" class="form-control required"  name="categoryname">
										</div>
									</div>
								</div>
							</div>
							...
							<div class="form-actions center">
								...
								<button type="submit" class="btn btn-raised btn-primary"  name="submit" value='submit'>
									<i class="fa fa-check-square-o"></i> Submit
                                                            ...
                                                            <a href="categorydetails-table.php"  class="btn btn-raised btn-dark">View Table</a>
							</div>
						</form>	
