        ...
        <div class="col-sm-12">
            <div class="card">
                <div class="card-header">
                    ...
                    <a href="suppliermedicinedetails-form.php"  class="btn btn-raised btn-info"style="float:right">Add</a>
                            ...
                            echo"<tbody>";
                              while ($row= mysqli_fetch_array($query))
                               ...
                               echo"<tr class='table-primary'>";
                                    ...
                                    echo "<td> <a href='suppliermedicinedetails-edit.php?editid=$row[0]' > <img src='img/edit.png' alternate='Edit' height='27' width='27'/>  </a> | <a href='Medicinedetails-table.php?did={$row['P_id']}' > <img src='img/delete.png' alternate='Delete' height='27' width='27'/> </a> </td>";
                                echo"</tr>";
                                }
