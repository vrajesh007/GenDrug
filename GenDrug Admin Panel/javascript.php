    <!-- BEGIN VENDOR JS-->
    <script src="vendors/js/core/jquery-3.3.1.js" type="text/javascript"></script>
    ...
    <script src="vendors/js/core/jquery.validate.js" type="text/javascript"></script>
    <script src="vendors/js/core/additional-methods.js" type="text/javascript"></script>
        <script>
