...
{
    header("location:suppliermedicinedetails-table.php");
}
...
if($_POST)
{
    ...
    if($updatequery)
    {
        echo "<script>alert('Record Updated');window.location='suppliermedicinedetails-table.php';</script>";
    }
}
?>
<html>
...
<div class="content-header">Edit</div>
    ...
    <div class="row match-height">
        ...
        <form method="post" id="myform" class="form" enctype="multipart/form-data">
            ...
            <button type="button" value="Cancel" class="btn btn-raised btn-warning mr-1" name="cancel" onclick="window.location='suppliermedicinedetails-table.php';">
