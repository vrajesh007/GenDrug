...
--
-- Host: 127.0.0.1
-- Generation Time: Jan 25, 2019 at 11:00 AM
...
INSERT INTO `userregistration` (`U_id`, `U_name`, `Gender`, `Phonenum`, `Email`, `Password`, `Conpassword`, `Address`) VALUES
(1, 'Vrajesh Trivedi', 'Male', '9409288425', 'trivedi.vrajesh007@gmail.com', '9409288425', '9409288425', '15, Government servant society, Opposite Municipal Market, C.G road.');
...
--
ALTER TABLE `categorydetails`
  MODIFY `Categ_id` int(6) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
...
--
ALTER TABLE `userregistration`
  MODIFY `U_id` int(6) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
COMMIT;
