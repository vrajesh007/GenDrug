...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 03, 2019 at 02:45 PM
...
(24, ' ACAMPROL ', '\r\nAcamprol 333mg Tablet is used with proper counseling for people dealing with alcoholism. It helps reduce alcohol dependency of people. It works by repairing the chemical balance in the brain. It is advised to not use this medication while still drinking alcohol.', 'Tablets', 54, 55, 'upload/acemprol-tablet-250x250.jpg', 4),
(25, 'AFENAK 100', 'Afenak 100 MG Tablet is used to relieve pain in the conditions like Osteoarthritis, Rheumatoid Arthritis, and Ankylosing Spondylitis. Do not take this medicine if you have any bleeding disorder, asthma or have a known allergy.', 'Tablets', 11, 55, 'upload/050217-172838_AMLIP 2.5MG TABLET-Genericwala.com.jpg', 4),
...
(38, 'ACUTRET 10MG TABLET', 'Acutret 10 MG Capsule is a naturally occurring derivative of vitamin A and is used for the treatment of severe acne (nodular) non-responsive to other therapies.', 'Tablets', 145, 50, 'upload/24.jpg', 4),
...
--
ALTER TABLE `symptomdetails`
  MODIFY `Symp_id` int(6) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;
